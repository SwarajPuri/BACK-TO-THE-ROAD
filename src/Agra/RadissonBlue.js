...
import img1 from './RB1.jpg'
import img2 from './radison2.jpg'
import img3 from './radison3.jpg'
...
const [formInput, setFormInput] = useReducer(
    ...
    return (
      <div>
        <h1>........</h1>
          <h1 align="centre">RADISON BLUE</h1>
          <div>
            <Container>
        <Carousel>
  <Carousel.Item>
  ...
  <tbody>
    ...
    <FormControlLabel
      ...
      <td><Button href={"/booking"} as="input" type="button" value="Confirm Booking" onClick={()=>handleSubmit()} /></td>
    </tr>
  </tbody>
</Table>
      </div>
