...
import img1 from './Lemon Tree Premier Hitec.jpg'
import img2 from './Radisson Blu Plaza.jpg'
import img3 from './Novotel.jpg'
...
class Hotel_Hyderabad extends Component {
  ...
  <Card>
    ...
    <Card.Body>
      ...
      <Card.Title><h1>Lemon Tree Premier Hitec</h1></Card.Title>
    ...
    <Card.Footer>
      <small className="text-muted"><Button href="/lemonTreePremierHitec">Book your stay</Button></small>
    </Card.Footer>
  </Card>
  <Card>
    <Card.Img variant="top"  src={img2} style={{ height: '22rem' }}/> 
    <Card.Body>
      <Card.Title><h1>Radisson Blu Plaza</h1></Card.Title>
      <Card.Text>
    ...
    <Card.Footer>
      <small className="text-muted"><Button href="/radissonBluPlaza">Book your stay</Button></small>
    </Card.Footer>
  </Card>
  <Card>
    <Card.Img variant="top" src={img3} style={{ height: '22rem' }}/>
    <Card.Body>
      <Card.Title><h1>Novotel</h1></Card.Title>
      <Card.Text>
    ...
    <Card.Footer>
      <small className="text-muted"><Button href="/novotel">Book your stay</Button></small>
    </Card.Footer>
  </Card>
</CardGroup>
