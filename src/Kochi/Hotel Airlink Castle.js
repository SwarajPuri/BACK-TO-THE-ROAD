...
import img1 from './Airlink4.jpg'
import img2 from './Airlink5.jpg'
import img3 from './Airlink6.jpg'
...
const [formInput, setFormInput] = useReducer(
    (state, newState) => ({ ...state, ...newState }),
    {
      ...
      "ppl_agra": "string",
      "days_agra": "string",
      "hotel_agra":"Hotel Airlink Castle",
      "city_agra":"KOCHI"
    ...
    return (
      <div>
        <h1>........</h1>
          <h1 align="centre">Hotel Airlink Castle</h1>
          <div>
            <Container>
        <Carousel>
  <Carousel.Item>
