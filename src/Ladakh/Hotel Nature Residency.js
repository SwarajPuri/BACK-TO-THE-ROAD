...
import img1 from './nature4.jpg'
import img2 from './nature5.jpg'
import img3 from './nature6.jpg'
...
const [formInput, setFormInput] = useReducer(
    (state, newState) => ({ ...state, ...newState }),
    {
      ...
      "ppl_agra": "string",
      "days_agra": "string",
      "hotel_agra":"Hotel Nature Residency",
      "city_agra":"LADAKH"
    ...
    return (
      <div>
        <h1>........</h1>
          <h1 align="centre">Hotel Nature Residency</h1>
          <div>
            <Container>
        <Carousel>
  <Carousel.Item>
