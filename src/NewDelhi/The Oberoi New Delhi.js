...
import img1 from './oberoi4.jpg'
import img2 from './oberoi5.jpg'
import img3 from './oberoi1.jpg'
...
const [formInput, setFormInput] = useReducer(
    (state, newState) => ({ ...state, ...newState }),
    {
      ...
      "ppl_agra": "string",
      "days_agra": "string",
      "hotel_agra":"The Oberoi New Delhi",
      "city_agra":"NEWDELHI"
    ...
    return (
      <div>
        <h1>........</h1>
          <h1 align="centre">The Oberoi New Delhi</h1>
          <div>
            <Container>
        <Carousel>
  <Carousel.Item>
