...
import img1 from './white4.jpg'
import img2 from './white5.jpg'
import img3 from './white6.jpg'
...
const [formInput, setFormInput] = useReducer(
    (state, newState) => ({ ...state, ...newState }),
    {
      ...
      "ppl_agra": "string",
      "days_agra": "string",
      "hotel_agra":"The White Haven Homestay",
      "city_agra":"NEWDELHI"
    ...
    return (
      <div>
        <h1>........</h1>
          <h1 align="centre">The White Haven Homestay</h1>
          <div>
            <Container>
        <Carousel>
  <Carousel.Item>
